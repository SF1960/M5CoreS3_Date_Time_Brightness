...
#define colGreen 0x489754

// screen definitions
#define CAMERA_TOP 3
#define CAMERA_BOTTOM 1

// screen brightness variables
byte brightness[5] = {32, 100, 175, 200, 255};             // define brightness steps
int chosenBrightness = 1;                                  // set to 2nd brightness level
...
// interval to toggle the power data
unsigned long PreviousPowerMillis = 0;                     // display sleep
const long UpdatePower = 1000 * 5;                         // five seconds
int PowerToggle = 1;                                       // 1 = Level, 2 = Volts, 3 = Amps
